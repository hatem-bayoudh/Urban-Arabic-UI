    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
      <div className="lg:col-span-8 space-y-8">
          ...
          <div className="relative z-10 max-w-2xl">
            ...
            <div className="relative group">
              <Input
                ...
                placeholder={
                  isRtl
                    ? "ابحث عن كلمة، تعبير، أو مدينة..."
                    : "Search for a word, expression, or city..."
                }
                className="h-16 text-lg bg-white shadow-sm dark:bg-surface-container"
              />
            </div>
          </div>
        </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <TermGridCard term={MOCK_TERMS[1]} className="md:col-span-1" />
          <TermGridCard term={MOCK_TERMS[2]} className="md:col-span-1" />
          <TermGridCard
            term={MOCK_TERMS[3]}
            type="image"
      ...
      <aside className="lg:col-span-4 space-y-6">
        ...
        <Card variant="low" className="p-6 rounded-[1.5rem]">
          ...
          <div className="space-y-3">
            {[
              {
                flag: "🇪🇬",
                name: isRtl ? "المصرية" : "Egyptian",
                trend: "+12%",
              },
              {
                flag: "🇱🇧",
                name: isRtl ? "اللبنانية" : "Levantine",
                trend: "+8%",
              },
              ...
              <div
                key={i}
                className="flex items-center justify-between p-4 bg-surface-container-lowest rounded-2xl hover:bg-surface-container transition-colors cursor-pointer"
              >
                <div className="flex items-center gap-3">
                  <FlagEmoji flag={item.flag} size={28} />
        ...
        <Card variant="low" className="p-6 rounded-[1.5rem]">
          ...
          <div className="space-y-2">
            {[
              ...
              <div
                key={i}
                className="flex items-center justify-between p-3 hover:bg-surface-container-high rounded-xl transition-colors cursor-pointer"
              >
                <span className="font-bold text-on-surface">{item.term}</span>
                <span className="text-xs text-on-surface-variant">
                  {item.count} {isRtl ? "بحث" : "searches"}
                </span>
              </div>
            ))}
          </div>
        ...
        <section className="relative overflow-hidden rounded-[2rem] bg-primary p-8 text-primary-foreground">
          ...
          <h4 className="text-2xl text-white font-black mb-4 font-headline">
            {isRtl ? "انضم لمجتمعنا" : "Join Our Community"}
          </h4>
          <p className="text-primary-foreground/70 text-white text-sm mb-8 leading-relaxed">
            {isRtl
